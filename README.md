...
- Scalability: The ability to Add/Remove new features without having to refactoring the application.
- Stability: Adding/Removing new features without introducing critical bugs.
