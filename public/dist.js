...
},{"../../patch/fixdatastore":4,"./ui/folder-form":8,"./ui/folder-list":9,"./ui/list":10,"./ui/modal":11,"./ui/task-form":12}],6:[function(require,module,exports){
"use strict";
...
var FolderForm = {
  init: function init(anchorID) {
    ...
    this.render();
    var self = this; //var createButton = __container.find("#create-folder");
  ...
  setFolder: function setFolder() {
    ...
    //   id: __state.folder.id,
    //   name: __state.folder.name
    // };
  ...
  renderListItem: function renderListItem() {
    ...
    if (!__state.list.length) {
      ...
      __state.list.map(function (_item, index) {
        content += "\n                <li data-folder-id=\"".concat(_item.id, "\" data-folder-index=\"").concat(index, "\">\n                  <p>").concat(index + 1, " - ").concat(_item.name, "</p>\n                </li>");
      });
    }

    __container.html("<ul> ".concat(content, " </div> "));
  }
};
...
},{"../service/eventstore":7}],12:[function(require,module,exports){
"use strict";
